...
namespace AppTask.Controllers
{
    public class CentralCustoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var centralCusto = await _context.CentralCusto
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var centralCusto = await _context.CentralCusto.FindAsync(id);
            if (centralCusto == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (centralCusto != null)
            {
                _context.CentralCusto.Remove(centralCusto);
            }
        ...
        {
            return _context.CentralCusto.Any(e => e.Codigo == id);
        }
    }
}
