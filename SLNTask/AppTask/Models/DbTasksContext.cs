...
public partial class DbTasksContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Funciona__06370DAD14063F67");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Incident__06370DADA879AFC1");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Tarefa__06370DADE34ED265");
